...
public:
	...
	using CreateMove_t                 = bool( __thiscall* )( void*, int, float, bool );
	...
	using ProcessMovement_t = void(__thiscall*)(void*, void*, void*);
	using AllocKeyValuesMemory_t = void* (__thiscall*)(void*, int);
...
public:
	...
	bool					 CreateMove(int sequence_number, float input_sample_frametime, bool active, bool& bSendPacket);
	...
	bool                     IsConnected( );
	void ProcessMovement(Player* player, CMoveData* data);
